...
class _AllianceSelectionState extends State<AllianceSelection> {
  ...
  final int _numberOfTeamsPerAlliance =
      4; //TODO this should be synced as part of event configuration
                                    ...
                                    Visibility(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: TextField(
                                          ...
                                          onChanged: (value) {
                                            AllianceSelectionEventTeam? team =
                                                eventTeams
                                                    .where(
                                                      (t) =>
                                                          t.team.number ==
                                            ...
                                            setState(() {
                                              numberInputPreview = (team.picked)
                                                  ? "❌"
                                                  : "✅";
                                              numberInputPreview +=
                                                  team.team.nickname;
