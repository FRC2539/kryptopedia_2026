      ...
      table.add(
        TableRow(
          children: [
            ...
            TeamInfoTables.displayCell(
              "${stats.teleopClimbedPercents[1].toStringAsFixed(0)}%, ${stats.teleopClimbedPercents[2].toStringAsFixed(0)}%, ${stats.teleopClimbedPercents[3].toStringAsFixed(0)}%",
              false,
              context,
              100.0,
              Colors.white,
            ...
            TeamInfoTables.displayCell(
              "${(stats.summaryPenaltiesPercents[2] + stats.summaryPenaltiesPercents[3]).toStringAsFixed(0)}%",
              false,
              context,
              70.0,
              Colors.white,
