...
class SuperNumberField extends StatefulWidget {
  final String label;
  ...
  @override
  State<SuperNumberField> createState() => _SuperNumberFieldState();
}

class _SuperNumberFieldState extends State<SuperNumberField> {
